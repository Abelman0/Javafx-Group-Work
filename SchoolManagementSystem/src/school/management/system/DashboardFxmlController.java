...
public class DashboardFxmlController implements Initializable {
    ...
    public void teachersDeleteBtn() {
        if (teachers_teacherID.getText().isEmpty()) {
            errorMessage("Please fill TeacherID blank field");                                                                // if one of them is null or empty it calles the emptyFields method
...
//            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); // set the date format to match the format used in SQLite
    ...
    public void studentsDeleteBtn() throws SQLException {
        ...
        connect = DatabaseConnection.connectionDB();
        if (students_studentID.getText().isEmpty()) {
            errorMessage("Please fill StudentID blank field");                                                                // if one of them is null or empty it calles the emptyFields method
